      ...
      <Card className="w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-700 bg-gray-800 transition-all duration-300 ease-in-out hover:shadow-[0_10px_20px_rgba(128,90,213,0.5)]">
        <CardHeader>
            <div className="flex justify-between items-center">
                <div>
                    {space.isActive ? <Badge className="bg-green-500">Active</Badge> : <Badge variant='destructive'>Inactive</Badge>}
                </div>
                <div className="text-white">
                    {space.isPublic ? <Unlock/> : <Lock/>}
                </div>
            </div>
        </CardHeader>
        <CardContent className="p-0">
          ...
          >
            ...
            >
                <h2 className="mb-1 text-2xl font-bold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl">
                    {space.name} 
                </h2>
            </motion.div>
          </motion.div>
